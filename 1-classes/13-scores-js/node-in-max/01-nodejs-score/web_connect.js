...
io.on('connection', (socket) => {
    ...
    // FIRST IMAGE WELCOME
    readStream = fs.createReadStream(path.resolve(__dirname,'./esp5.jpg'),{encoding: 'binary'});
    ...
    socket.on('newImage',(image) => {
        ...
        readStream2 = "";
        readStream2 = fs.createReadStream(path.resolve(__dirname,'./esp2.jpg'),{encoding: 'binary'});
        //io.emit('mess', msg);
