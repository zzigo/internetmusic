...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 182.0, 62.0, 86.0, 22.0 ],
					"text" : "read cbsn.wav"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.0, 96.0, 33.0, 22.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 5.0, 382.0, 29.0 ],
					"text" : "IM-12 FluCoMa - 02. Segmentation"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 593.0, 395.0, 98.0, 22.0 ],
					"text" : "fluid.bufchroma~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 593.0, 357.0, 116.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 593.0, 318.0, 83.0, 22.0 ],
					"text" : "fluid.bufmfcc~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 593.0, 278.0, 106.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 593.0, 213.0, 150.0, 33.0 ],
					"text" : "analyze the parts with audiodescriptors"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 332.0, 100.0, 229.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 332.0, 20.0, 209.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 332.0, 60.0, 94.0, 22.0 ],
...
,
					"patching_rect" : [ 65.999999666666668, 591.0, 49.0, 22.0 ],
...
,
					"patching_rect" : [ 65.999999666666668, 339.0, 196.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 65.999999666666668, 297.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 128.0, 104.5, 142.0, 22.0 ],
									"text" : "fluid.dataset~ normalised"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 30.0, 104.5, 93.0, 22.0 ],
...
,
					"patching_rect" : [ 66.0, 256.0, 139.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 806.0, 202.0, 150.0, 114.0 ],
									"text" : "analyzes the whole buffer frame by frame and gives the resource to the buffer\n\n\nchannel 1: RMS analysis\nchannel 2: true peak analysis"
								}
...
,
					"patching_rect" : [ 66.0, 211.0, 62.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 318.0, 546.0, 66.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 49.0, 52.0, 150.0, 22.0 ]
								}
...
,
					"patching_rect" : [ 66.0, 168.0, 52.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 65.999999666666668, 382.0, 192.0, 192.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 222.0, 211.0, 326.0, 37.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 318.0, 732.0, 55.0, 22.0 ],
					"text" : "dac~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 318.0, 579.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 66.0, 60.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 114.0, 127.0, 226.0, 22.0 ],
					"text" : "buffer~ sound Nicol-LoopE-M.wav 48000"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 75.499999666666668, 624.0, 304.0, 624.0, 304.0, 540.0, 327.5, 540.0 ],
					"source" : [ "obj-23", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-43", 0 ],
					"midpoints" : [ 105.499999666666668, 624.0, 265.0, 624.0, 265.0, 374.0, 75.499999666666668, 374.0 ],
					"source" : [ "obj-23", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 327.5, 729.0, 363.5, 729.0 ],
					"order" : 0,
					"source" : [ "obj-54", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 327.5, 717.0, 327.5, 717.0 ],
					"order" : 1,
					"source" : [ "obj-54", 0 ]
				}
