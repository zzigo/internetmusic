...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 185.5, 91.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 238.5, 147.0, 106.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 614.0, 127.5, 110.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 782.0, 449.0, 376.0, 301.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 782.0, 407.0, 376.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 818.0, 372.5, 292.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 65.5, 566.0, 242.0, 119.0 ],
					"text" : "P5js sketch (as any HTML/JavaScript document loaded to jweb) can send messages to Max or to fill dict object with a custom content.\n\nLook at the code in the \"sketch.js\" file attached to this example for details."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 572.33331298828125, 478.5, 171.0, 212.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 998.0, 78.0, 290.0, 252.0 ],
					"text" : "Max can interact with P5js sketch by calling functions (with parameters or not) located inside the P5js sketch.\n\n\"set_background_color\" and \"set_stroke_color\" are functions located inside the \"sketch.js\" file and available from Max patcher.\n\nTo define inside P5js sketch functions accessible from Max patcher use \"window.max.bindInlet\" function described in \"Communicating with Max from within jweb\" document (part of Max documentation).\n\nLook at the code in the \"sketch.js\" file attached to this example to see how to use \"window.max.bindInlet\" function inside P5js sketch."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 901.66668701171875, 143.0, 83.0, 22.0 ],
					"text" : "loadmess 255"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 764.66668701171875, 143.0, 70.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 960.0, 81.0, 20.0, 20.0 ],
					"text" : "B"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 924.66668701171875, 81.0, 20.0, 20.0 ],
					"text" : "G"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 891.33331298828125, 81.0, 20.0, 20.0 ],
					"text" : "R"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 833.0, 81.0, 20.0, 20.0 ],
					"text" : "B"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 787.66668701171875, 81.0, 20.0, 20.0 ],
					"text" : "G"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 744.33331298828125, 81.0, 20.0, 20.0 ],
					"text" : "R"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 960.0, 103.0, 20.0, 140.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 924.66668701171875, 103.0, 20.0, 140.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 891.33331298828125, 103.0, 20.0, 140.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 856.0, 255.0, 123.0, 35.0 ],
					"text" : "pak set_stroke_color 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 856.0, 304.0, 66.0, 22.0 ],
					"text" : "s #0tojweb"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 833.0, 103.0, 20.0, 140.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 787.66668701171875, 103.0, 20.0, 140.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 744.33331298828125, 103.0, 20.0, 140.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 699.0, 255.0, 153.0, 35.0 ],
					"text" : "pak set_background_color 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 699.0, 304.0, 66.0, 22.0 ],
					"text" : "s #0tojweb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 113.0, 449.0, 69.0, 22.0 ],
					"text" : "unpack i i"
				}
...
, 			{
				"box" : 				{
					...
					"rendermode" : 2,
					"url" : "file:///Users/paweljanicki/Documents/projects/MaxAndP5js/v06/MaxAndP5js/01_messaging_and_dictionaries/p5js/index.html"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 172.5, 518.0, 122.5, 518.0 ],
					"source" : [ "obj-5", 1 ]
				}
